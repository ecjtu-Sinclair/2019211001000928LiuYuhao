			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.LiuYuhao.model.Order o=(com.LiuYuhao.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.LiuYuhao.dao.UserDao userDao=new com.LiuYuhao.dao.UserDao();
						...
						<%
							...
							String paymentType=com.LiuYuhao.model.Payment.findByPaymentId(con,n);
							 %>
